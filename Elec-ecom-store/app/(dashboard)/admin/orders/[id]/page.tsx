...
const AdminSingleOrder = () => {
  ...
  useEffect(() => {
    const fetchOrderData = async () => {
      const response = await fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/orders/${params?.id}`
      );
    ...
    const fetchOrderProducts = async () => {
      const response = await fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/order-product/${params?.id}`
      );
  ...
  const updateOrder = async () => {
    if (
      ...
      fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/orders/${order?.id}`, {
        method: "PUT", // or 'PUT'
        headers: {
  ...
  const deleteOrder = async () => {
    ...
    fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/order-product/${order?.id}`, requestOptions).then((response) => {
      fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/orders/${order?.id}`, requestOptions).then((response) => {
