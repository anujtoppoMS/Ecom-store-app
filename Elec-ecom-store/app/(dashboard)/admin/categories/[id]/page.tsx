...
const DashboardSingleCategory = ({
  ...
  const deleteCategory = async () => {
    ...
    fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/categories/${id}`, requestOptions)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/categories/${id}`)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
