...
const DashboardSingleUserPage = ({
  ...
  const deleteUser = async () => {
    ...
    fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/users/${id}`, requestOptions)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    fetch(`${`http://${process.env.BACKEND_API_SERVICE_HOST}:${process.env.BACKEND_API_SERVICE_PORT}`}/api/users/${id}`)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
